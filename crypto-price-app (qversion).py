...
* **YouTube Channel:** [Streamlit (Web Application in Python)](https://www.youtube.com/playlist?list=PLtqF5YXg7GLmCvTswG32NqQypOuYkPRUE)
* **Download:** [How to download the selected price lists?](https://discuss.streamlit.io/t/how-to-download-file-in-streamlit/1806)
""")
...
## Sidebar - Currency price unit (column 1)
currency_price_unit = col1.selectbox('Select currency for price', ('HKD', 'USD', 'BTC', 'ETH'))

# Web scraping of CoinMarketCap data
@st.cache
def load_data():
    cmc = requests.get('https://coinmarketcap.com')     # url & html
    soup = BeautifulSoup(cmc.content, 'html.parser')    # Beautiful object
